...
test('directory-submissions', () => {
  ...
  assert.deepEqual(normalizeAspectLabels(['Cost', ' cost ', '', 'Developer Experience']), [
    'Cost',
    'Developer Experience',
  ]);
  assert.deepEqual(normalizeAspectLabels(['Quality', 'QUALITY', 'quality']), ['Quality']);
  assert.deepEqual(normalizeAspectLabels(['  whitespace   between  words  ']), [
