...
export const DIRECTORY_SIGNALS: DirectorySignal[] = [
  ...
  {
    slug: 'hosting',
    keywords: ['hosting', 'host', 'deploy', 'deployment', 'paas', 'vercel', 'netlify', 'fly.io'],
  },
  {
  ...
  {
    slug: 'css-tools',
    keywords: ['css', 'styling', 'tailwind', 'css framework', 'styles', 'stylesheet'],
  },
  {
  ...
  {
    slug: 'orms',
    keywords: ['orm', 'query builder', 'database client', 'prisma', 'drizzle', 'data mapper'],
  },
  {
    slug: 'api-frameworks',
    keywords: [
  ...
  {
    slug: 'llm-gateways',
    keywords: ['llm gateway', 'ai gateway', 'model router', 'llm proxy', 'model gateway'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['package manager', 'npm', 'pnpm', 'yarn', 'bun install', 'dependencies'],
  },
  {
    slug: 'bundlers',
    keywords: ['bundler', 'build tool', 'webpack', 'vite', 'esbuild', 'rollup', 'bundling'],
  },
  {
    slug: 'test-runners',
    keywords: [
  ...
  },
  {
    ...
    keywords: ['linter', 'formatter', 'lint', 'eslint', 'prettier', 'biome', 'code style'],
  },
  {
  ...
  {
    slug: 'headless-cms',
    keywords: ['cms', 'headless cms', 'content management', 'content', 'contentful', 'sanity'],
  },
  {
    slug: 'state-management',
    keywords: ['state management', 'state', 'store', 'redux', 'zustand', 'jotai', 'global state'],
  },
  {
  ...
  {
    slug: 'dns',
    keywords: ['dns', 'domain name', 'nameserver', 'name server', 'dns provider', 'managed dns'],
  },
  {
