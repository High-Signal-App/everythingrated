    ...
    <div className="mx-auto w-full max-w-3xl px-6 py-14">
      ...
      <div className="mt-6">
        ...
        <p className="mt-3 max-w-2xl text-[14px] leading-[1.6] text-[var(--muted)]">
          Propose a missing AI dev tool for owner review. Approved suggestions become rateable
          items; duplicates are merged or blocked. You can keep rating existing tools while we
          review.
        </p>
      </div>
      ...
      <Card className="mt-8">
        <CardBody>
          <ItemSubmissionForm directorySlug={directory.slug} directoryName={directory.name} />
        </CardBody>
      </Card>
    </div>
  );
