...
export const metadata: Metadata = {
  ...
  description:
    "Public endpoints for each directory — JSON items, RSS feed, random-item redirect.",
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mt-3 text-sm text-[var(--muted)]">
        Public, read-only. Substitute <code>[slug]</code> with any
        directory&apos;s slug (e.g. <code>ai-dev-tools</code>).
      </p>
