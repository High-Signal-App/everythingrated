    ...
    <div className="mx-auto w-full max-w-3xl px-6 py-14">
      ...
      <div className="mt-6">
        ...
        <p className="mt-3 max-w-2xl text-[14px] leading-[1.6] text-[var(--muted)]">
          EverythingRated now does one job: multi-axis ratings for AI dev tool decisions. New
          directories are on hold while that use case is proven. Existing directories keep their
          pages and ratings.
        </p>
        <div className="mt-8">
          <Link
