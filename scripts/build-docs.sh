...
#
# Requires Node.js 22.12+. Blume is pinned in package.json (devDependencies).
# Generated output lands in dist/ (gitignored).
#
# Usage:
#   bash scripts/build-docs.sh             # build -> dist/
...
#
# Equivalents via pnpm scripts:
#   pnpm docs:build / pnpm docs:dev / pnpm docs:validate / pnpm docs:check
#
set -euo pipefail
