...
the durable history lives in the repository-root `PROJECT_STATUS.md` and the
rendered [architecture decisions](../architecture/decisions/README.md).

## Where the current state lives

| You want | Read |
| --- | --- |
| One-screen current state (objective, active work, blockers, next steps) | repository-root `STATUS.md` |
| Full durable history + shipped feature inventory | repository-root `PROJECT_STATUS.md` |
